...
\sid{Risks to O. gluma and its significance to rice breeding...}
...
\sid{ gluma gene flow by abcission }
"...populations of
O. glumaepatula
with occurrence in hydrographic basins,
plants with reproductive tillers are released to float on the
surface of the watercourse. This migration ability of
O. glumaepatula facilitates seed dispersal over short and
long distances and increases the intensity of the gene flow"
\cite{Akimoto1998}

\sid{ gluma fixation index and inbreeding }
"The estimated fixation index (F^IS) was
0.79 that differed significantly from zero, indicating high inbreeding within each O. glumaepatula population.
The total inbreeding of the species (F^IT) was 0.98 and the genetic diversity indexes among populations,
F^ST and R^ST, were 0.85 and 0.90, respectively, indicating high genetic variability among them."

\sid{O. gluma vs O. rufipogan}
